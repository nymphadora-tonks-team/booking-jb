...
public class ScooterServiceImpl implements ScooterService {
    ...
    public Scooter findScooterById(String scooterId) {
        ...
        try {
            ...
            LOGGER.error("FIND SCOOTER BY ID - service function. scooterId = {}", scooterId);
    ...
    public Set<Scooter> findAllScooters() {
        ...
        try {
            ...
            LOGGER.error("FIND ALL SCOOTER - service function");
            LOGGER.error(ExceptionUtils.getStackTrace(e));
            throw new ServiceException(e);
        }
    ...
    public Scooter createScooter(final Scooter scooter) {
        ...
        try {
            ...
            LOGGER.error("CREATE SCOOTER - service function. Scooter = {}", scooter);
            LOGGER.error(ExceptionUtils.getStackTrace(e));
            throw new ServiceException(e);
        }
    }
